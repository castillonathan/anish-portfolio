    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-16 flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div>
            <p className="text-xs font-medium uppercase tracking-[0.3em] text-black/40 md:text-sm">
  Selected Work
</p>

<h2 className="mt-5 text-5xl font-bold leading-[0.9] tracking-[-0.06em] md:text-8xl">
  Things I've
  <br />
  created.
</h2>
